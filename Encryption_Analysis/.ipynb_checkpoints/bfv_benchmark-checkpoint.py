...
def run_bfv_benchmark():
    images = load_and_preprocess_cifar10(t=37)
    ...
    result = benchmark_algo_in_batches(encrypt, decrypt, params, images, "BFV")
